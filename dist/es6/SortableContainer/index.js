      ...
      value: function animateNodes() {
        ...
        for (var i = 0, len = nodes.length; i < len; i++) {
          ...
          if (transitionDuration) {
            nodeStyleUpdates.push({ node: node, property: vendorPrefix + 'TransitionDuration', value: transitionDuration + 'ms' });
          }
          ...
          nodeStyleUpdates.push({ node: node, property: vendorPrefix + 'Transform', value: 'translate3d(' + translate.x + 'px,' + translate.y + 'px,0)' });
        }
